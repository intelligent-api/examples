...
public class BasicAuth {
    public static void main(String args[]) {
        ...
        String usersDate = "[[users_date]]";
        String usersDay = "[[users_day]]";
        String usersTime = "[[users_time]]";
        String userAgent = "Intelligent API Sample Java Code";

        String jsonPayload = "{ \"text\": \"" + textBody + "\", \"usersDate\": \"" + usersDate + "\", \"usersDay\": \"" + usersDay + "\", \"usersTime\": \"" + usersTime + "\" }";

        // invoke the API endpoint
        try {
            HttpClient client = HttpClient.newHttpClient();
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("https://api.intelligent-api.com/v1/text/todo"))
