...
public class BasicAuth {
    public static void main(String args[]) {
        ...
        String jsonPayload = "{ \"text\": \"" + textBody + "\", \"classifications\": [\"Food & Dining\", \"Transport\", \"Shopping\", \"Utilities\", \"Entertainment\", \"Health\", \"Education\", \"Other\"] }";

        // invoke the API endpoint
        try {
            HttpClient client = HttpClient.newHttpClient();
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("https://api.intelligent-api.com/v1/text/expenses"))
