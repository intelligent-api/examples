...
func main() {
	...
	payload := []byte(fmt.Sprintf(`{"text": "%s", "usersDate": "%s", "usersDay": "%s", "usersTime": "%s"}`, textBody, usersDate, usersDay, usersTime))

	// invoke the API endpoint
	uri := "https://api.intelligent-api.com/v1/text/todo"
