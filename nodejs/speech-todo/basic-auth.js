...
(async () => {
  try {
    ...
    const usersDate = "[[users_date]]";
    const usersDay = "[[users_day]]";
    const usersTime = "[[users_time]]";
    ...
    const options = {
      ...
      port: 443,
      path: `/v1/speech/todo?user_date=${usersDate}&user_day=${usersDay}&user_time=${usersTime}`,
      method: "POST",
      headers: {
