...
{
    items = new[] { "McDonalds Quarter Pounder deluxe", "McDonalds Regular Coke", "Gym Membership", "Beef Steak", "Multi-vitamin", "Petrol", "Car tires" },
    classifications = new[] { "Food & Dining", "Transport", "Shopping", "Utilities", "Entertainment", "Health", "Education", "Other" }
};
...
{
    var request = new HttpRequestMessage(HttpMethod.Post, "https://api.intelligent-api.com/v1/text/classify/multiple");
